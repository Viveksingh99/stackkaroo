  ...
  return (
    <>
      <div className="text-center my-10">
        <Typography color="#E68F50" variant="h5" fontSize="40px" marginBottom="10px" fontWeight={600} fontFamily="outfit">
          Stackkaroo’s Talent Hiring & Job Placement Services
        </Typography>
        <Typography variant="subtitle2" fontFamily="outfit" fontWeight={500} fontSize="22px" color="#36454F">
      ...
      {Data.map((item, index)=>(
        ...
        <Image
          ...
          />
            <Typography variant="h6" color='#0A56F1' fontWeight={600} fontSize="22px" fontFamily="outfit" component="div" sx={{ margin: 'auto', marginY:'20px' }}>
             {item.title}
            </Typography>
            <Typography variant="body2" color="#36454F" fontSize="20px" fontFamily="Outfit" fontWeight={600} sx={{ marginBottom:'20px'}}>
              {item.discription}
            </Typography>
          </CardContent>
        </Card>
